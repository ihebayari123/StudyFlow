...
class Utilisateur
{
    ...
    /**
     * @return Collection<int, StressSurvey>
     */
    public function getStressSurveys(): Collection
    {
        return $this->stressSurveys;
    }

    public function addStressSurvey(StressSurvey $stressSurvey): static
    {
        if (!$this->stressSurveys->contains($stressSurvey)) {
            $this->stressSurveys->add($stressSurvey);
            $stressSurvey->setUser($this);
        }

        return $this;
    }

    public function removeStressSurvey(StressSurvey $stressSurvey): static
    {
        if ($this->stressSurveys->removeElement($stressSurvey)) {
            // set the owning side to null (unless already changed)
            if ($stressSurvey->getUser() === $this) {
                $stressSurvey->setUser(null);
            }
        }
