 ...
 */
final class Version20260205205729 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD statut_compte VARCHAR(255) NOT NULL, DROP statutCompte, CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE nom nom VARCHAR(255) NOT NULL, CHANGE prenom prenom VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE role role VARCHAR(255) NOT NULL, CHANGE motDePasse mot_de_passe VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD motDePasse VARCHAR(255) NOT NULL, ADD statutCompte ENUM(\'actif\', \'inactif\') DEFAULT \'actif\', DROP mot_de_passe, DROP statut_compte, CHANGE id id INT UNSIGNED AUTO_INCREMENT NOT NULL, CHANGE nom nom VARCHAR(100) NOT NULL, CHANGE prenom prenom VARCHAR(100) NOT NULL, CHANGE email email VARCHAR(150) NOT NULL, CHANGE role role ENUM(\'enseignant\', \'admin\', \'etudiant\') NOT NULL');
